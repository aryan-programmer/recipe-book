	 ...
	 */
		_enableDatepicker: function (target) {
			...
			if (nodeName === "input") {
				...
				inst.trigger.filter("button").each(function () { this.disabled = false; }).end().filter("img").css({
					                                                                                                   opacity: "1.0",
					                                                                                                   cursor : ""
				                                                                                                   });
			} else if (nodeName === "div" || nodeName === "span") {
	 ...
	 */
		_disableDatepicker: function (target) {
			...
			if (nodeName === "input") {
				...
				inst.trigger.filter("button").each(function () { this.disabled = true; }).end().filter("img").css({
					                                                                                                  opacity: "0.5",
					                                                                                                  cursor : "default"
				                                                                                                  });
			} else if (nodeName === "div" || nodeName === "span") {
